...
/*
    ...
    3) check Columns function- checks if a column is empty
        ...
        if there is a matching number insert number into that column and multiply the value by 1,2, or 3, then add points

        if opponent has the same number, place it in that column and destroy matching numbers on the opposite team, then deduct points
        else place randomly
